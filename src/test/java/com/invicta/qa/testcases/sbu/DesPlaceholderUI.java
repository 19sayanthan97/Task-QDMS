...
public class DesPlaceholderUI extends DriverIntialization {
	...
	public void sbu() throws InterruptedException {
		...
		String placeholderVal = AddSbuFunPage.Desplaceholder.getAttribute("placeholder");
		String expectedVal = "Enter Description";
		...
		boolean AcctualElement = AddSbuFunPage.Desplaceholder.isDisplayed();
...
// OPACITY
		...
		String actualElementopacity = AddSbuFunPage.Desplaceholder.getCssValue("opacity");
		...
		Point ActualLocation = AddSbuFunPage.Desplaceholder.getLocation();
		...
		Point ExpectedLocation = new Point(693, 189);
		...
		String actualElementfamily = AddSbuFunPage.Desplaceholder.getCssValue("font-family");
		...
		String Actualfontcolor = AddSbuFunPage.Desplaceholder.getCssValue("color");
